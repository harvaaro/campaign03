...
public class SinglyLinkedList<E> implements List<E> {
	protected NodeSingle<E> head = null;
	protected NodeSingle<E> tail = null;
	protected NodeSingle<E> tempNode = null;
	...
	protected void nodeSetAdd(E dataToAdd, int atIndex) {
		NodeSingle<E> addNode = new NodeSingle<>(dataToAdd);
		...
		if (atIndex == 0) {
			...
			NodeSingle<E> prevNode = getNode(atIndex-1);
	 ...
	 */
	protected NodeSingle<E> getNode(int index) {
		NodeSingle<E> seekNode = head;
